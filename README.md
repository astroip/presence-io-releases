...
[![Stable](https://img.shields.io/badge/canal-Stable-brightgreen?style=flat-square)](https://www.jdeploy.com/gh/astroip/presence-io-app-releases)
...
|---|---|---|
| 🟢 **Stable** | Releases validées, recommandé pour tous | [Installer Stable](https://www.jdeploy.com/gh/astroip/presence-io-app-releases) |
| 🟣 **Labs** (Early Access) | Dernières fonctionnalités, early adopters | [Installer Labs](https://www.jdeploy.com/~presence-io-labs-app) |

> Stable utilise le mode officiel jDeploy `deploy_target: github` sur
> `astroip/presence-io-app-releases`, donc sa page publique est de type
> `https://www.jdeploy.com/gh/<owner>/<repo>`.
